...
model = load_model(path + 'k31_260914_1340-0070-3493.4333.keras')
...
# hist = model.fit(x_train, y_train, epochs = 1500, validation_split=0.125, callbacks=[es, mcp])
