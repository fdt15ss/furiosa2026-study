...
model.fit(x_train, y_train, epochs=2, batch_size=16, validation_split=0.125)
end_time = time.time()  # 현재 시간을 반환. 끝시간
...
# submission.to_csv(path + 'submit/' + 'submit_20260907_01.csv')
