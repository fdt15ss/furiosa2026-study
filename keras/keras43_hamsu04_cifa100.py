...
conv2d1 = Conv2D(64, (3,3), input_shape=x_test[0].shape, activation="relu")(input1)
conv2d2 = Conv2D(128, (2,2), activation="relu")(conv2d1)
conv2d3 = Conv2D(128, (2,2), activation="relu")(conv2d2)
maxpooling2d1 = MaxPooling2D((2,2))(conv2d3)
drop1 = Dropout(0.3)(maxpooling2d1)
conv2d4 = Conv2D(256, (2,2), activation="relu")(drop1)
maxpooling2d2 = MaxPooling2D((2,2))(conv2d4)
drop2 = Dropout(0.3)(maxpooling2d2)
gap2d1 = GlobalAveragePooling2D()(drop2)
dense1 = Dense(256, activation="relu")(gap2d1)
