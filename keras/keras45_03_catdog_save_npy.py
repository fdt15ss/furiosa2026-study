...
np.save(path + 'keras_45_kaggle_cat_dog_x_train.npy', x_train)
np.save(path + 'keras_45_kaggle_cat_dog_y_train.npy', y_train)
np.save(path + 'keras_45_kaggle_cat_dog_x_test.npy', x_test)
np.save(path + 'keras_45_kaggle_cat_dog_y_test.npy', y_test)