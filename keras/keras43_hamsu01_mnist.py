...
drop2 = Dropout(0.2)(conv2d4)
conv2d5 = Conv2D(16, (2,2), activation='relu')(drop2)
maxpooling2d1 = MaxPooling2D((2,2))(conv2d5)
drop3 = Dropout(0.2)(maxpooling2d1)
conv2d6 = Conv2D(16, (2,2), activation='relu')(drop3)
gap2d1 = GlobalAveragePooling2D()(conv2d6)
dense1 = Dense(128, activation='relu')(gap2d1)
