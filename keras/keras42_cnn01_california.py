...
model = Sequential()
model.add(Conv2D(4, (2,2), input_shape=x_test[0].shape, activation="relu", padding="same"))
...
#4. 평가, 예측
print('훈련 시간 :',round(end_time - start_time, 3), '초')
...
# r2(함수형 모델) :  0.5847970890888217

# 총 시간(gpu) : 70.532 초
# loss(gpu) : 0.5809165835380554
# r2(gpu) :  0.5539950437331809

# 총 시간(cpu) : 39.475 초
# loss(cpu) : 0.5878893136978149
# r2(cpu) :  0.5486416738040829

# Epoch 61: early stopping
# 훈련 시간 : 76.488 초
# loss : 0.5596432685852051
# r2 :  0.5703277140244857