...
x_train = np.load(path + 'keras_45_kaggle_cat_dog_x_train.npy')
y_train = np.load(path + 'keras_45_kaggle_cat_dog_y_train.npy')
x_test = np.load(path + 'keras_45_kaggle_cat_dog_x_test.npy')
y_test = np.load(path + 'keras_45_kaggle_cat_dog_y_test.npy')
