...
#2. 모델구성
model = Sequential()
model.add(Conv2D(64, (2, 2), input_shape = x_train[0].shape, activation="relu", padding="same"))
...
save_path = "./_save/keras31/dacon_ddarung/"
...
# loss(save) : (2968.4990234375,)
# rmse(save) : 54.48393409787356

# loss(dropout) : (2959.43359375,)
# rmse(dropout) : 54.40067503936678

# rmse(함수형) : 54.06660085849856

# 총 시간(gpu) : 9.783 초
# 총 시간(cpu) : 9.958 초

# 총 시간(CNN) : 13.614 초
# loss(CNN) : (3161.76611328125,)
# rmse(CNN) : 56.2295861819446