...
model = load_model(save_path + 'k31_260914_1411-0009-2773.8298.keras')
...
submission.to_csv(path+ 'submit/' + 'submit_20260914_01.csv')
# print("========================== hist =========================")
# print(hist)
# print("========================== hist.history =========================")
# print(hist.history)
...
# loss(load) : (2968.4990234375,)
# rmse(load) : 54.48393409787356