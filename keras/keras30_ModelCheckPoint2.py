...
# model.save_weights(path + 'keras29_5_save_1.weights.h5') #초기가중치
model = load_model(path + 'keras30_mcp1.keras') # 초기 가중치 상태
# model.summary()
...
# hist = model.fit(x_train, y_train, epochs=1000, validation_data=(x_val, y_val), callbacks=[es, mcp],
#                  verbose=1)
# end_time = time.time()
